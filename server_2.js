// ------- CREAR SERVIDOR WEB SIN FRAMEWORK - MODULO GLOBAL HTTP Y FS ------- //
...
// 8. IMPORTAR EL MODULO GLOBAL FS //
const fs = require('fs');
...
// 5. CREAR EL SERVIDOR WEB MANERA 2. Funcion anomina directamente como parametro. Se puede con function expresion o function declaration.
    ...
    /* http.createServer(function(req, res){
        ...
        const server = http.createServer((req,res)=>{
            ...
            //8. CREACION DE UN ARCHIVO CUANDO HAYA UN REQUEST //
            if(url === '/message' && method === 'POST'){
                fs.writeFileSync('message.txt', 'Jose Arley Pabon Celis, su codigo si esta funcionando. FELICITACIONES!!!');
                res.statusCode = 302; //302 -> codigo de redireccionamiento
                res.setHeader('Location', '/');
                return res.end();

                // fs.writeFileSync(file, data, options): Escribe datos en un archivo de forma sincrónica (bloqueante)
            }
